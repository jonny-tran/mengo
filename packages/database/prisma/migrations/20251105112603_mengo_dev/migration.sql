...
-- CreateIndex
CREATE UNIQUE INDEX "Epic_title_projectId_key" ON "Epic"("title", "projectId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Task_title_epicId_key" ON "Task"("title", "epicId");

-- CreateIndex
CREATE INDEX "ChecklistItem_taskId_idx" ON "ChecklistItem"("taskId");

-- CreateIndex
CREATE UNIQUE INDEX "ChecklistItem_text_taskId_key" ON "ChecklistItem"("text", "taskId");
