...
// Helper functions outside component to avoid impure function errors
...
export default function AppDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-background page-gradient-bg p-4 md:p-8">
      ...
      <Generating open={showGenerating} briefContent={briefContent} />
    </div>
  );
}
